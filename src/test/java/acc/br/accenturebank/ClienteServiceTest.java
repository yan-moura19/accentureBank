...
class ClienteServiceTest {
    ...
    void testUpdateCliente() {
        ...
        assertNotNull(result);
        assertEquals("joao_novo@example.com", result.getEmail());
        assertEquals("(83)91283-3845", result.getTelefone());
        assertEquals("58402-025", result.getCep());
        assertEquals("60", result.getNumeroEndereco());
        assertEquals("Apto 1", result.getComplemento());
        verify(clienteRepository, times(1)).save(any(Cliente.class));
    }
    ...
    void testUpdateClienteNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> clienteService.updateCliente(1, updateClienteDTO));
    }
